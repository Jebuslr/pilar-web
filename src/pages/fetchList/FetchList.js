  ...
  <>
    <Grid container spacing={3}>
      ...
      <Grid item xs={4} >
        ...
        open={open} 
        >
           <BootstrapDialogTitle id="customized-dialog-title" onClose={handleClose} sx={{alignSelf:'center',fontSize:35}}>
          {data?data.name:"_"}  <Avatar sx={{width: 150, height: 150}} src={data?data.sprites.front_default:""}></Avatar>
        </BootstrapDialogTitle>
         <DialogContent dividers sx={{ width: 500, height: 300}}>
